...
class ArriveStopTrip extends StatelessWidget {
  const ArriveStopTrip({
    super.key,
      ...
      builder: (context, state) {
        return state.displayManualMarket
            ...
            : FadeInUp(
                ...
                child: _ArriveStopTrip(scrollController: scrollController));
      },
    );
  }
}

class _ArriveStopTrip extends StatefulWidget {
  const _ArriveStopTrip({
    super.key,
    required this.scrollController,
  });
  ...
  @override
  State<_ArriveStopTrip> createState() => _ArriveStopTripState();
}

class _ArriveStopTripState extends State<_ArriveStopTrip> {
  @override
  void initState() {
    super.initState();
    updateLocation();
    prefs.actualStop = prefs.actualStop + 1;
  }
